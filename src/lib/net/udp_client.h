...
sky_bool_t sky_udp_client_read_all(sky_udp_client_t *client, sky_uchar_t *data, sky_usize_t size);

sky_isize_t sky_udp_client_read_nowait(sky_udp_client_t *client, sky_uchar_t *data, sky_usize_t size);

sky_usize_t sky_udp_client_write(sky_udp_client_t *client, const sky_uchar_t *data, sky_usize_t size);

sky_bool_t sky_udp_client_write_all(sky_udp_client_t *client, const sky_uchar_t *data, sky_usize_t size);
