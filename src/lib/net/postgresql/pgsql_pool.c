...
static sky_bool_t pg_socket_options(sky_tcp_t *conn, void *data);
...
static sky_pgsql_result_t *pg_exec_read(sky_pgsql_conn_t *conn);
...
static sky_bool_t
pg_socket_options(sky_tcp_t *conn, void *data) {
    (void) data;
