...
#define skt_memmove2(_dist, _src) sky_memcpy2(_dist, _src)

#define skt_memmove4(_dist, _src) sky_memcpy4(_dist, _src)

#define skt_memmove8(_dist, _src) sky_memcpy8(_dist, _src)
